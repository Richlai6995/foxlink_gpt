...
2. **11 金屬週漲跌幅統計 — 必須輸出完整 markdown 表格(這是採購最看重的欄位,不能省)**
   ...
   \`\`\`
   | 燈號 | 金屬品種 | 本週最新報價 | 週漲跌幅 | 主要驅動因素與市場現況 |
   | :---: | :--- | ---: | :---: | :--- |
   | 🔴 | **銅 (Cu)** | 13,819 (6/1) | **+1.5%** | 美元偏弱與電網需求帶動,LME 庫存連 3 日減少。 |
   | 🟢 | **鋁 (Al)** | 3,795 (6/1) | **-0.7%** | 中國電解鋁產量回升,庫存累積壓抑漲勢。 |
   | 🔴 | **鎳 (Ni)** | 19,050 (6/1) | **+0.9%** | 印尼 RKAB 配額審查趨嚴,供應預期收緊。 |
   | 🔴 | **鋅 (Zn)** | 3,555 (6/1) | **+0.2%** | 鋼鐵終端需求平穩,煉廠加工費 (TC) 持平。 |
   | 🟢 | **鉛 (Pb)** | 2,008 (6/1) | **-0.4%** | 鉛酸電池替換需求疲弱,二次供應充足。 |
   | 🔴 | **錫 (Sn)** | 56,400 (6/1) | **+2.5%** | 印尼出口暫停疑慮持續,半導體焊料需求穩定。 |
   | 🟡 | **金 (Au)** | 4,555 | **+0.0%** | 美元指數震盪,降息預期未明朗,金價橫盤。 |
   | 🟢 | **銀 (Ag)** | 75.66 (6/1) | **-0.8%** | 光電需求回穩但工業避險買盤退潮。 |
   | 🔴 | **鉑 (Pt)** | 1,993 | **+2.3%** | 南非礦業擾動消息,氫能催化劑需求預期升溫。 |
   | 🔴 | **鈀 (Pd)** | 1,408 | **+1.1%** | 汽車觸媒採購回升,俄羅斯供應風險持續。 |
   | 🟢 | **銠 (Rh)** | 8,600 | **-2.3%** | 電動車滲透率上升,稀有金屬避險買盤退場。 |
   \`\`\`
   ...
   **欄位定義**(每欄都必須填,不可省略):
     ...
     - **本週最新報價** — 取 \`{{pm_weekly_changes}}\` anchor 區塊「本週最新」那個價(箭頭右側,單位 USD),數字千分位逗號。
       ⚠️ 若 anchor 的「本週最新」日期跟今天 {{date}} 差 > 3 天 → **括號加標日期**:\`13,819 (6/1)\`。
       ⚠️ 若 anchor 的日期是這週(差 ≤ 3 天) → 直接寫數字不加日期:\`4,555\`。
...
2. **11 金屬月漲跌統計 — 必須輸出完整 markdown 表格(這是採購最看重的欄位,不能省)**
   ...
   \`\`\`
   | 燈號 | 金屬品種 | 本月最新報價 | 月漲跌幅 | 主要驅動因素與市場現況 |
   | :---: | :--- | ---: | :---: | :--- |
   | 🔴 | **銅 (Cu)** | 13,819 (6/1) | **+5.1%** | 美元持續走弱、AI 電網建設驅動長線需求,月內庫存連降。 |
   | 🟢 | **鋁 (Al)** | 3,795 (6/1) | **-2.3%** | 中國電解鋁供應回升,終端需求復甦不如預期。 |
   | 🔴 | **鎳 (Ni)** | 19,050 (6/1) | **+1.8%** | 印尼配額審查趨嚴,不鏽鋼採購回穩。 |
   | 🟢 | **鋅 (Zn)** | 3,555 (6/1) | **-1.4%** | 鍍鋅板需求疲軟,煉廠加工費下調。 |
   | 🟢 | **鉛 (Pb)** | 2,008 (6/1) | **-3.2%** | 鉛酸電池替換需求疲弱,庫存累積壓抑。 |
   | 🔴 | **錫 (Sn)** | 56,400 (6/1) | **+6.8%** | 印尼出口受限延續,半導體封測需求穩定。 |
   | 🟡 | **金 (Au)** | 4,555 | **-2.2%** | 美元反彈、降息預期延後,金價月線收斂。 |
   | 🔴 | **銀 (Ag)** | 75.66 (6/1) | **+3.7%** | 光電產業裝置量續創新高,工業需求支撐。 |
   | 🟢 | **鉑 (Pt)** | 1,993 | **-0.3%** | PGM 板塊整體疲弱,氫能應用尚未大規模放量。 |
   | 🟢 | **鈀 (Pd)** | 1,408 | **-6.6%** | 燃油車滲透率下滑,觸媒需求結構性走弱。 |
   | 🟢 | **銠 (Rh)** | 8,600 | **-11.0%** | 電動車快速取代燃油車,貴金屬避險買盤退場。 |
   \`\`\`
   ...
   **欄位定義**(每欄都必須填,不可省略):
     ...
     - **本月最新報價** — 取 \`{{pm_monthly_changes}}\` anchor 區塊「本月最新」那個價(箭頭右側,單位 USD),數字千分位逗號。
       ⚠️ 若 anchor 的日期跟今天 {{date}} 差 > 3 天 → **括號加標日期**:\`13,819 (6/1)\`。差 ≤ 3 天直接寫數字。
