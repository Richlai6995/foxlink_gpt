...
2. **11 金屬週漲跌幅統計與排序 — 必須輸出完整 markdown 表格(這是採購最看重的欄位,不能省)**
   ...
   \`\`\`
   | 排名 | 燈號 | 金屬品種 | 本週最新報價 | 週漲跌幅 | 主要驅動因素與市場現況 |
   | :---: | :---: | :--- | ---: | :---: | :--- |
   | **1** | 🔴 | **白銀 (Ag)** | 32.45 | **+11.4%** | 避險買盤與光電轉型需求雙擊,滬銀單週飆升。 |
   | **2** | 🔴 | **錫 (Sn)** | 31,250 (5/22) | **+8.5%** | 印尼實體斷供疑慮發酵,引發短線資金擠倉逼空行情。 |
   | ... | ... | ... | ... | ... | ... |
   \`\`\`
...
2. **11 金屬月漲跌統計與排序 — 必須輸出完整 markdown 表格(這是採購最看重的欄位,不能省)**
   ...
   \`\`\`
   | 排名 | 燈號 | 金屬品種 | 本月最新報價 | 月漲跌幅 | 主要驅動因素與市場現況 |
   | :---: | :---: | :--- | ---: | :---: | :--- |
   | **1** | 🔴 | **白銀 (Ag)** | 33.80 | **+18.5%** | 光電產業需求 + 避險買盤共振,月線突破前高。 |
   | **2** | 🔴 | **錫 (Sn)** | 32,300 (5/22) | **+12.3%** | 印尼出口限制延續整月,LME 庫存創新低引發逼空。 |
   | ... | ... | ... | ... | ... | ... |
   \`\`\`
