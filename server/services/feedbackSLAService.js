 ...
 * SLA 通知受 system_settings.feedback.sla_enabled 控制(預設 false):
 *   - enabled=false:只跑「自動結案 72hr」,不發 SLA warning / breached
 */
...
function startSLACron() {
  ...
  console.log(`[FeedbackSLA] Starting cron every ${checkMinutes} minutes (auto-close always runs; warning/breached gated by feedback.sla_enabled)`);
