    ...
    if (imageOutput) {
      ...
      if (allDeclarations.length > 0) {
        ...
        if (pureDify) {
          ...
          const toolsInstruction = [skillExtraInstruction, langInstruction].filter(Boolean).join('\n\n---\n\n');
        ...
        try {
          ...
          const combinedInstruction = [skillExtraInstruction, templateExtraInstruction, langInstruction].filter(Boolean).join('\n\n---\n\n');
          if (providerType === 'azure_openai' && modelRow) {
