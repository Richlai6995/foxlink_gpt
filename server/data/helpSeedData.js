      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "type": "list",
            "items": [
              "**配色**:5 組預設(Blue/Green/Warm/Purple/Teal)+ 自訂 5 色",
              "**文字**:標題 / 軸 / 圖例三組字級",
              "**排版**:圖例位置(上/下/左/右/隱藏)、顯示 Y 軸格線、深色/淺色背景",
              "**數字格式**:原始 / 千分位 / 百分比;整數 / 1 位 / 2 位小數",
              "**圖型個別**:折線平滑、圓餅甜甜圈樣式",
              "**長條圖專屬**:圓角、透明度、陰影立體感、**每支 bar 不同色**(單系列時)、**自訂每根 bar 顏色**(依序對應 8 色)、動畫(關閉/從底部長出/淡入/彈跳)、逐個浮現交錯"
            ]
          },
          {
            "type": "tip",
          ...
          {
            "type": "subsection",
            "title": "樣式模板 — 一次設定所有圖都套用",
            "blocks": [
              {
                "type": "para",
                "text": "到「我的圖庫」第 3 個 tab「樣式模板」可以建立 / 編輯命名模板。把其中一個設為「預設」(星號標示)後:"
              },
              {
                "type": "list",
                "items": [
                  "對話中 AI 自動產生的所有圖表會**立即套用**該模板樣式",
                  "ERP 工具圖表 tab 的預覽、下載、儲存也會用該模板",
                  "所有既有釘選的圖(owner 是你)會跟著換(除非你對個別圖表做過本地微調)",
                  "每個使用者只能有 1 個 default,重複點星號即取消 default(退回系統預設)"
                ]
              },
              {
                "type": "note",
