...
const userSections = [
  ...
  },
  {
    ...
    "blocks": [
      {
        "type": "para",
        "text": "**主要網址(2026-05-11 起)**:`https://flgpt.foxlink.com.tw`(內外網皆可使用同一網址)。內網舊書籤 `https://flgpt.foxlink.com.tw:8443` 仍可使用,不需立即更換。"
      },
      {
        "type": "subsection",
        ...
        "blocks": [
          ...
          {
            "type": "note",
            "text": "**內外網皆可用 SSO(2026-05-11 起)**:從公司外網(出差、家用、手機 4G)也可以走 SSO 登入。SSO 完成後,外網用戶仍會接著走 Webex / Email 雙通道驗證碼,跟帳密登入的安全等級一致,沒有 MFA bypass 風險。"
          },
          {
            "type": "tip",
      ...
      },
      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "Cortex 是 PWA(Progressive Web App),**加到主畫面後可像 native App 一樣開啟**,沒有瀏覽器網址列,有自己的 icon、全螢幕體驗,還支援自動更新通知。是手機使用者建議的方式。"
          },
          {
            "type": "subsection",
            ...
            "blocks": [
              ...
              {
                "type": "tip",
                "text": "**首次開啟 Cortex 在 Safari 時會自動跳出藍色教學提示框**告訴你怎麼加入主畫面,點「看詳細步驟」即可展開逐步說明。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "**Chrome 會自動偵測並彈出「安裝應用程式」提示框**,點「安裝」即可加到主畫面。如果沒看到提示:"
              },
              {
                "type": "steps",
                "items": [
          ...
          {
            "type": "note",
            "text": "**新版本通知**:當 IT 部署新功能,Cortex 會在右下角彈出「新版本可用」通知,點「更新」即可拿到最新版,**不需要清 cache 或重灌**。如果某次更新後沒看到新功能,通知 5 分鐘內會自動彈出,點一下即可。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "為了讓對話內容能完整展開、減少操作時忽上忽下,手機介面 2026-05 改成 **Gemini App 風格**:上方 Topbar 大幅精簡,常用控制項全部下放到輸入區下方的「控制列」,跟輸入框一起放在底部。"
          },
          {
            "type": "subsection",
            "title": "畫面分區",
            "blocks": [
              ...
              {
                "type": "tip",
                "text": "控制列左半(`+` / 模型 / 齒輪)是「配置」類功能,右半(麥克風 / 送出)是「輸入/送出」類,中間刻意留出空白,避免錄音結束想點 mic 時誤碰齒輪。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                ...
                "items": [
                  ...
                  "**`[✨]` 閃光 icon**:切換 LLM 模型(Gemini 3 Pro / Flash / Azure GPT-5 等)。長按或點 icon 上會顯示當前模型名,點開可換",
                  "**`[⚙]` 齒輪**:設定選單(切語言 / 主題風格 / 我的裝置 / 登出 等)。右上角紅點代表有未讀回饋",
                  "**`[🎤]` 麥克風**:語音輸入。**點一下開始錄音**(icon 變紅色閃爍),再點一下結束並送 server 辨識為文字插入輸入框。也可改用手機輸入法自帶的語音功能,二擇一",
                  "**`[▶]` 送出 / `[■]` 停止**:傳送訊息;AI 生成中改顯示停止鍵可中斷"
                ]
              },
              {
                "type": "note",
                "text": "錄音中 mic icon 是紅色脈動。錄音上限 60 秒,到時自動停。中途想取消可再點一下 mic。"
              }
            ]
          },
          {
            ...
            "blocks": [
              ...
              {
                "type": "tip",
                "text": "輸入框 max 5 行,超出會自動出現捲軸,不會吃掉整個畫面。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "list",
                "items": [
                  "**本月消耗**:看自己當月用了多少 Token / 預算",
                  "**純對話模式**:跳過所有工具/KB,只跟 LLM 對話",
                  "**分享當前對話**:產生唯讀連結給同事看",
                  "**技能市場 / 文件模板 / 我的圖庫 / 問題反饋**:跳到對應頁面",
                  "**語言**:zh-TW / en / vi 三語切換",
                  "**主題風格**:深色 / 深色護眼 / 藍/綠/黃調 五選一,跨裝置同步",
                  "**我的裝置 / 快速登入**:管理信任裝置 + Face ID/指紋 passkey 綁定",
                  "**說明 / 登出**"
                ]
              }
            ]
      ...
      },
      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "綁定後可用本機生物辨識**直接登入,不用打密碼**。資料只在裝置本機驗證,系統僅儲存公鑰(passkey 標準 / WebAuthn),即使 Cortex DB 被入侵也無法重建您的指紋 / 臉孔。"
          },
          {
            "type": "subsection",
            "title": "第一次啟用",
            "blocks": [
              {
                ...
                "items": [
                  ...
                  {
                    "title": "登入完成後系統會彈出「**啟用快速登入**」對話框",
                    "desc": "若您按「稍後再說」,7 天內不會再彈;手動啟用走下面步驟"
                  },
                  {
                    "title": "點「**立即啟用**」,系統觸發手機 / 電腦的生物辨識提示"
                  },
                  {
                    "title": "完成 Face ID / 指紋 驗證,綁定完成",
                    "desc": "裝置會以「iPhone / Android / Mac / Windows」等名稱記在「我的裝置」"
                  }
                ]
              },
              {
                "type": "tip",
                "text": "**手動啟用入口**:左下角狀態列點「我的裝置 / 快速登入」(手機:右上 ⚙ 選單 → 我的裝置 / 快速登入)→ 在「快速登入(Face ID / 指紋)」區塊按「**綁定當前裝置**」。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                ...
                "items": [
                  {
                    "title": "進到登入頁,密碼欄上方會多一個**綠色「使用 Face ID / 指紋登入」按鈕**",
                    "desc": "只在當前裝置支援且綁過時才出現"
                  },
                  {
              ...
              {
                "type": "note",
                "text": "**通過 Face ID = 等同已通過 MFA**:passkey 本身已是「裝置擁有 + 生物辨識」雙因素,系統認為足夠強度,免再走 Webex 驗證碼。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "在「我的裝置」頁面的「快速登入(Face ID / 指紋)」區塊可看到所有綁定:"
              },
              {
                "type": "list",
                "items": [
          ...
          },
          {
            ...
            "blocks": [
              ...
              {
                "type": "note",
                "text": "**遺失裝置但還能登入**:用其他綁定裝置或帳密登入後從「我的裝置」移除遺失那台。**完全進不去**:聯絡 IT 部門,管理員可在後台直接重置您所有綁定。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "**Android 手機若出現以下錯誤** 多半是手機本身設定問題,可逐項檢查:"
              },
              {
                "type": "list",
                "items": [
              ...
              {
                "type": "note",
                "text": "**iOS 通常無此問題**(iCloud Keychain 預設啟用)。Android < 13 用舊 FIDO2 API,不會踩到 Credential Manager 問題。"
              },
              {
                "type": "tip",
                "text": "即使生物辨識綁定失敗,**完全不影響正常登入** — 您仍可走帳密 + Webex/Email 驗證碼,通過後同裝置免重認。生物辨識只是 UX 加速,不是必要。"
              }
            ]
          }
        ]
      ...
      },
      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "當您**從新裝置完成驗證碼**(系統根據裝置 fingerprint 判斷,信任裝置 30 天內未過期就視為已知)時,Webex Bot 會主動私訊您「**新裝置登入提醒**」,內含時間 / IP / 裝置資訊。**同一裝置上 IP 變動不會觸發**(出差、行動網路、撥接 IP 變更等情境不再造成通知噪音)。"
          },
          {
            "type": "note",
        ...
        "items": [
          ...
          },
          {
            ...
            "items": [
              ...
              "頂部工具列「純對話」toggle（💬）：**一鍵停用所有工具 / 知識庫 / 技能**，直接走 LLM 對話 — 工具多到不知道怎麼選、或不想被自動匹配時用，設定永久保存（瀏覽器級）",
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "type": "subsection",
        "title": "純對話模式（💬）— 一鍵停用所有工具",
        "blocks": [
          {
            "type": "para",
            "text": "頂部工具列「技能」按鈕右邊有一個「純對話」toggle，點一下就會**完全停用所有工具、知識庫、技能、API 連接器**，讓 AI 直接以最單純的對話方式回應。"
          },
          {
            "type": "list",
            "items": [
              "**何時用**：問日常問題（不需要查公司資料 / 不需要叫工具）、想要最快回應、想避免 AI 自動引用不相關的工具或知識庫",
              "**啟用後外觀**：「純對話」按鈕變橘色 + ✓ 圖示，左邊的 MCP / API / 知識庫 / 技能 / AI 戰情 按鈕全部變灰且無法點擊",
              "**輸入框上方會出現橘色提示條**：明確告訴您「純對話模式已啟用」，點提示條右邊的「關閉純對話」即可一鍵恢復",
              "**設定永久保存**：在您的瀏覽器中永久記住，下次登入仍是純對話狀態，直到您手動關閉"
            ]
          },
          {
            "type": "tip",
            "text": "純對話模式下 AI 回應通常會更快（因為 server 不需要掃過所有工具與知識庫做自動匹配）。如果發現某些功能（如查公司知識庫、執行技能）「沒反應」，請先確認頂部「純對話」是否被誤啟用。"
          },
          {
            "type": "note",
            "text": "純對話模式不會清除您原本掛載的技能或選擇的知識庫，只是**這次對話暫時不引用**。關閉純對話後，您之前的選擇全部還在，繼續沿用。"
          }
        ]
      },
      {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "工具列各下拉選單（MCP / API / 知識庫 / 技能 / ERP）中，每個項目右側都有 👁 眼睛圖示。點一下可將該工具收進「已隱藏」摺疊區，讓選單看起來更清爽 — 同時系統不會再把這個工具送給 AI。"
          },
          {
            "type": "list",
            "items": [
              "**對 AI 完全隱藏（不只是 UI 摺疊）** — 送出訊息時，後端會把您隱藏的工具從 function declarations 中剃除，LLM 完全看不到也不會呼叫。可有效降低首字回應時間（ttft），因為 AI 不需要掃描那麼多工具來判斷是否呼叫。",
              "**Auto 與 Explicit 都生效** — 不論讓系統自動路由（TAG），還是您明確勾選工具，隱藏的工具都不會被送進候選清單。",
              "**連自動路由的技能也擋掉** — 如果您隱藏了「轉聲音」這類技能，即使您的訊息撞到該技能的關鍵字（Tag），系統也不會自動把它加進候選工具。",
              "**僅影響您自己** — 隱藏狀態存在您的瀏覽器（localStorage），不會影響同事。換瀏覽器或筆電會回到全部可見的初始狀態。",
              "**隨時可恢復** — 在「已隱藏」摺疊區再點一次眼睛圖示，工具立即重新顯示並可勾選。",
              "**不影響 AI 戰情室、深度研究** — 那兩條路徑有自己獨立的工具集，不受您的隱藏設定影響。"
            ]
          },
          {
            "type": "note",
            "text": "適合場景：某些工具您完全用不到（例如採購人員看不到「捷運即時動態」、業務人員看不到「程式碼優化」技能），隱藏起來就不會干擾 AI 的路由判斷，選單也清爽，AI 回應也更快。"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "tip",
            "text": "最精確的方式：下拉選單明確勾選目標工具 + 關閉不需要的類別開關。最省力的方式：所有工具設定好 Tags，讓系統 TAG 路由自動判斷。常用不到的工具點 👁 隱藏起來，可降低 AI 判斷負擔、加快回應。"
          }
        ]
      },
      {
  ...
  },
  {
    ...
    "blocks": [
      {
        "type": "para",
        "text": "知識庫市集讓您可以將企業內部文件向量化，建立專屬的語意搜尋資料庫。對話時掛載知識庫，AI 會先從知識庫檢索最相關的段落，再結合自身能力回答，大幅提升對特定領域文件（如 SOP、技術手冊、規格書）的回答準確度。除了文件之外，也支援**圖片上傳**：AI 自動產生圖片描述讓圖能被檢索，並在對話回覆中自動嵌入相關圖片。"
      },
      {
        "type": "subsection",
        "title": "前提條件",
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              {
                "title": "（選用）勾選「保密知識庫」",
                "desc": "紅底 checkbox。勾選後此知識庫**不可申請公開**，且系統管理員預設**看不到內容**（僅看得到名稱），詳見下方「保密知識庫」一節"
              },
              {
          ...
          {
            "type": "note",
            "text": "建立後可在「分塊與檢索設定」頁籤調整「自動抽取文件內嵌圖片到圖庫」開關（預設啟用）。詳見下方「文件內嵌圖自動抽取」一節。"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              {
                "title": "（選用）在上傳列調整本次參數",
                "desc": "可覆寫「格式解析模式」「PDF OCR」「抽取圖」三個 KB 預設值，僅影響本次上傳"
              },
              {
                "title": "系統自動解析文字並進行 Embedding 向量化",
                "desc": "圖片與 PDF 中的圖片會先 OCR 轉文字，再一起向量化；若啟用「抽取圖」，內嵌圖會額外存到圖庫供 AI 在對話中嵌入引用"
              },
              {
      ...
      },
      {
        ...
        "blocks": [
          {
            "type": "note",
            "text": "保密知識庫用於存放敏感資料（薪資、人事、客戶機密、合約等）。即使是系統管理員，沒被擁有者主動分享前也**看不到內容**。"
          },
          {
            "type": "para",
            "text": "保密 KB 的特殊規則："
          ...
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "建立時：在建立 Modal 勾選「保密知識庫」checkbox。"
              },
              {
                "type": "para",
                "text": "建立後切換：進入「分塊與檢索設定」頁籤 → 上方「保密設定」區（**僅擁有者可見**）→ 勾 / 取消勾後 Save。"
              },
              {
                "type": "tip",
                "text": "從公開 KB 切換為保密 KB 時，系統會自動取消公開狀態（含 pending 申請）並彈出提示確認。切換動作會寫入 audit log（系統管理員可在審計日誌查到）。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "保密 KB 仍可透過正常「共享設定」流程把使用權限給特定使用者（包括管理員）：進入詳情頁 → 「共享設定」頁籤 → 對 user/role/dept 等授權即可。被分享者就能看內容、用對話查詢。"
              },
              {
                "type": "note",
                "text": "保密 KB 的「申請公開」按鈕被擋下，請改用「共享」精準授權給需要的對象，不要試圖申請公開。"
              }
            ]
          }
        ]
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              {
                "title": "若檢索命中圖片（圖庫上傳的圖、文件內嵌圖），AI 會自動在回應中嵌入",
                "desc": "使用 `![描述](kb-img://...)` 語法，前端自動 fetch 並渲染；點圖可放大"
              }
            ]
          },
          {
          ...
          {
            "type": "note",
            "text": "**圖片回應建議用 Gemini Pro 模型**：Flash 系列對「複製貼上 36 字元 UUID」的指令服從性較弱，常會省略或改寫圖片引用碼，導致圖出不來。當您預期 AI 會回圖時（如「附上操作畫面」「請給我看截圖」），請切換到 Pro 模型。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "每個知識庫除了文件之外，還有獨立的「圖庫」頁籤，用來管理圖片資源。圖片可以是手動上傳，也可以是上傳文件時自動抽取出的內嵌圖。AI 在對話中檢索命中圖片時會自動嵌入回應。"
          },
          {
            "type": "subsection",
            "title": "手動上傳圖片",
            "blocks": [
              {
                "type": "para",
                "text": "進入知識庫詳情 → 點選「圖庫」頁籤 → 拖曳或點選上傳區域。支援 **PNG / JPEG / GIF / WebP / BMP**，單張最大 **20 MB**，一次最多 10 張。"
              },
              {
                "type": "steps",
                "items": [
                  {
                    "title": "上傳圖片",
                    "desc": "即時顯示在圖庫，右上角顯示黃色「AI 描述產生中」badge"
                  },
                  {
                    "title": "系統背景跑 Gemini Flash vision，產生 20-80 字描述 + OCR 文字"
                  },
                  {
                    "title": "描述完成後 badge 消失，圖卡顯示 caption 內容",
                    "desc": "頁面每 5 秒自動 polling，無需手動 refresh"
                  },
                  {
                    "title": "圖片自動建立一個 chunk 進入向量檢索",
                    "desc": "caption + filename 一併 embed，AI 在對話中可以用語意搜尋找到此圖"
                  }
                ]
              },
              {
                "type": "tip",
                "text": "若您已經知道圖片內容，可在上傳時的 form 直接給 caption 文字（會跳過 AI 自動產描述、節省 token）。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "點圖卡的「編輯描述」按鈕，修改 caption 後 Save → 系統會自動重新 embed 該圖的 chunk，下次檢索就會用新 caption 比對。"
              },
              {
                "type": "tip",
                "text": "若 AI 在對話中總是找不到某張圖，先檢查圖卡顯示的 caption 是否充分描述圖片內容、是否包含使用者可能會用的關鍵字。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "若 Gemini Vision 配額不足、圖片損壞、或內容無法解析（純黑、純白、雜訊），圖卡會顯示紅色「AI 描述失敗」badge，描述區改顯示錯誤訊息。"
              },
              {
                "type": "steps",
                "items": [
                  {
                    "title": "手動輸入描述",
                    "desc": "點「編輯描述」直接打字，即可救回該圖讓檢索可用"
                  },
                  {
                    "title": "或點 ↻ 重試按鈕（僅手動上傳圖才有）",
                    "desc": "系統會重新呼叫 vision API，若仍失敗請改用手動輸入"
                  }
                ]
              },
              {
                "type": "note",
                "text": "文件內嵌圖（doc_embed）失敗時不能單獨重試 — 請改對該文件按「重新解析」（Documents 頁籤）讓整份重跑。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "每張圖卡左上角有 checkbox，可勾選多張。工具列會自動顯示「已選 N 張」與紅色「刪除 N 張」按鈕（一次最多 200 張）。也可用工具列「全選」一次選取目前頁所有圖。"
              },
              {
                "type": "tip",
                "text": "刪除會同時清除實體檔、對應的 image chunk、以及 caption 失敗紀錄，無法復原。"
              }
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "上傳 docx / pptx / xlsx / PDF 時，系統可以**自動把文件內嵌的圖片抽出來存到圖庫**，這樣 AI 在對話中命中該文件相關 chunk 時，就能順便把對應圖嵌入回應，不只給文字。"
          },
          {
            "type": "subsection",
            "title": "開關設定",
            "blocks": [
              {
                ...
                "rows": [
                  ...
                  [
                    "上傳列的「抽取圖」下拉",
                    "單次上傳覆寫",
                    "可選「依 KB 預設」/「本次抽取」/「本次跳過」"
                  ]
                ]
              },
              {
                "type": "tip",
                "text": "若 KB 預設關閉但這次想抽，反之亦然，用上傳列的「抽取圖」覆寫即可，不需先改 KB 設定再改回來。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                ...
                "rows": [
                  ...
                  [
                    "PDF",
                    "⚠️ 僅 JPEG（DCTDecode）",
                    "PNG / FlateDecode 圖目前跳過（避免 sharp 依賴）"
                  ],
                  [
                    "DOC / PPT / XLS (97-2003)",
                    "❌ 不支援",
                    "舊版 Office 二進位格式抽圖代價過高"
                  ]
                ]
              },
              {
                "type": "note",
                "text": "PDF 限制說明：JPEG 印刷導出格式（產品 spec、報告書、簡報轉 PDF）通常都能抽到；純向量 PDF 或螢幕截圖 PDF（內部走 FlateDecode PNG）目前抽不到。若 PDF 圖很重要，建議改上傳原始 DOCX/PPTX 取代。"
              }
            ]
          },
          {
            ...
            "blocks": [
              ...
              {
                "type": "tip",
                "text": "若圖庫看起來都是 `image1.png` `image2.png` 不好分辨，建議在圖卡點「編輯描述」改 caption 加上自己的標記（如「ABC-100 產品照」），日後檢索 / 找圖都更方便。"
              }
            ]
          },
          {
            ...
            "blocks": [
              ...
              {
                "type": "note",
                "text": "若您先關閉「抽取圖」上傳一份文件，之後又想要這份文件的圖，可以開啟設定後對該文件按「重新解析」補抽。"
              }
            ]
          }
        ]
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "note",
            "text": "**保密 KB 共享規則**：保密 KB 的共享設定僅擁有者可管理（管理員也不能擅自 grant 給自己），且即使管理員想對保密 KB 操作，也必須先被擁有者主動分享 edit 權才能編輯。"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "note",
            "text": "**保密知識庫不可申請公開**：勾選保密的 KB，「申請設為公開」按鈕會被擋下並回應「保密知識庫不可申請公開,請先取消保密」。即使管理員端的核准 API 也會強制擋下保密 KB 變公開。"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "rows": [
              [
                "保密設定（僅擁有者）",
                "勾選後此 KB 變保密 KB，詳見「保密知識庫」一節",
                "依需求"
              ],
              [
                "文件圖片抽取",
                "上傳 docx/pptx/xlsx/PDF 時是否自動把內嵌圖存到圖庫",
                "預設啟用"
              ],
              [
                "分段識別符號",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "rows": [
              [
                "PDF",
                "pdf-parse 文字層 + Gemini OCR（有圖片時）+ JPEG 內嵌圖抽取",
                "掃描件需 OCR，速度較慢；JPEG 圖會抽到圖庫"
              ],
              [
                "DOCX / PPTX",
                "JSZip 解壓縮 XML → 提取段落文字 + 內嵌圖抽取",
                "保留標題層級與段落結構；圖會抽到圖庫"
              ],
              [
                "XLSX / CSV",
                "逐列讀取，保留欄標頭",
                "大型表格建議先分頁再上傳；XLSX 內嵌圖也會抽"
              ],
              [
                "TXT / MD",
                "直接讀取純文字",
    ...
    "blocks": [
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              {
                "title": "填寫任務名稱與執行頻率",
                "desc": "選擇每日 / 每週 / 每月 / 每隔幾小時 / 多時段等頻率，並設定幾點幾分執行"
              },
              {
      ...
      },
      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "在「排程設定」頁籤可選擇任務的觸發頻率，畫面下方會即時預估「接下來 5 次執行時間」供您確認："
          },
          {
            "type": "table",
            "headers": [
            ...
            "rows": [
              ...
              [
                "每月",
                "每月指定日期固定時間執行（建議 1–28 號避開月底落差）",
                "月結報表、月度統計"
              ],
              [
                "每隔 N 小時",
                "從整點起算，每隔 N 小時執行一次（N 為 1–23）",
                "盤中行情每 4 小時更新、定期巡檢"
              ],
              [
                "多時段",
                "一天內多個指定時間點各執行一次（最多 12 個）",
                "早中晚三次匯率快訊"
              ],
              [
                "進階 Cron",
                "直接填寫 5 欄位 Cron 運算式（分 時 日 月 週幾），可表達複雜規則",
                "只在工作日 9–17 點每 15 分執行"
              ]
            ]
          },
          {
            "type": "code",
            "text": "進階 Cron 範例（分 時 日 月 週幾）\n\n0 18 * * 1-5      週一到週五 18:00\n30 9 1 * *        每月 1 號 09:30\n0 8,14,20 * * *   每天 8 / 14 / 20 點\n*/15 9-17 * * 1-5 工作日 9–17 點每 15 分"
          },
          {
            "type": "tip",
            "text": "不確定 Cron 怎麼寫時，「多時段」可涵蓋大多數「一天跑好幾次」的需求，不需要記 Cron 語法。"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "para",
            "text": "**套用文件範本**：若想讓產出的檔案有固定版型（公司報告格式、表頭、樣式），可在 AI 設定頁的「輸出範本」欄位選擇已建立的範本。排程執行後，AI 的回應會自動解析為 JSON 套進範本生成檔案；也可在 Prompt 中用 `{{template:範本ID}}` 指定。"
          }
        ]
      },
      {
        "type": "subsection",
        "title": "在 Prompt 中直接引用工具（技能 / 知識庫 / API 連接器）",
        "blocks": [
          {
            "type": "para",
            "text": "撰寫排程 Prompt 時，可以直接在文字中引用已建立的技能（Skill）、知識庫（KB）和 API 連接器（DIFY / REST），系統執行時會自動呼叫對應的工具並將結果注入給 AI 分析。"
          },
          {
            "type": "table",
            "headers": [
            ...
            "rows": [
              ...
              [
                "{{dify:連接器名稱}}",
                "呼叫指定的 DIFY / REST API 連接器，將回應注入背景。預設以任務名稱當查詢字串",
                "{{dify:工單查詢}}"
              ],
              [
                "{{dify:連接器名稱 query=\"...\"}}",
                "同上，但明確指定查詢字串（覆蓋預設）",
                "{{dify:工單查詢 query=\"本日逾期工單\"}}"
              ]
            ]
          },
          {
            "type": "code",
            "text": "Prompt 引用工具範例\n\n今天是 {{date}}（{{weekday}}），\n請根據以下最新匯率資料 {{skill:匯率查詢}}\n以及生產 SOP 規定 {{kb:製程標準庫}}\n和工單系統回報 {{dify:工單查詢 query=\"本日逾期工單\"}}\n整理本日需注意事項並以繁體中文條列輸出。"
          },
          {
            "type": "tip",
            "text": "撰寫 Prompt 時，輸入 `{{skill:` 或 `{{kb:` 後，系統會自動彈出技能 / 知識庫名稱選單供快速選取，也可用斜線 `/` 觸發同樣的選單。API 連接器則可在「工具」頁籤的「可用 API 連接器」清單點「插入」加入。"
          },
          {
            "type": "note",
            "text": "API 連接器需先由系統管理員在「知識庫市集 → DIFY / API 連接器」建立並分享給您，才會出現在清單與可被引用。權限與您在對話中直接使用該連接器時相同。"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "rows": [
              ...
              [
                "**API 連接器**",
                "🔗 天藍",
                "呼叫 DIFY / REST API 連接器，query 預設接上一步輸出，可加固定參數",
                "工單系統查詢、外部資料 API"
              ],
              [
                "AI 追加（AI）",
              ...
              [
                "**知識庫寫入**",
                "📚 翠綠",
                "把前一步的 JSON 結果切塊向量化後寫入指定知識庫",
                "每日把新聞 / 公告自動收進 KB"
              ],
              [
                "**警示**",
                "🚨 紅色",
                "依門檻判斷（超標 / 與歷史均值比較等），符合條件才發 Email / Webex / Webhook 通知",
                "庫存超標警示、達交率異常通知"
              ],
              [
                "**DB 寫入**（Admin）",
                "📥 灰色",
                "把前一步的 JSON 結果寫入白名單資料表（僅系統管理員可建立）",
                "排程結果落地到 ERP 中介表"
              ],
              [
                "條件判斷",
          ...
          {
            "type": "note",
            "text": "「知識庫寫入」「警示」「DB 寫入」屬於進階節點，會產生實際的資料寫入或對外通知，建議先用單次手動執行（任務列表的 ▶ 立即執行）驗證無誤再啟用排程。其中「DB 寫入」僅系統管理員可建立。"
          },
          {
            "type": "para",
            "text": "每個節點都可設定「**失敗時行為**」："
          ...
          {
            "type": "para",
            "text": "部分節點（如 AI 戰情、合併 Excel）另有「**必要節點**」勾選：勾選後該節點失敗就 fail-fast 中斷整個 Pipeline；不勾選時失敗不中斷，但寄出的 Email 主旨 / 內文會標上 ⚠️ 提示某些節點未成功，方便您一眼看出這份報告不完整。"
          },
          {
            "type": "code",
      ...
      {
        "type": "subsection",
        "title": "API 連接器節點 — 排程跑 DIFY / REST 查詢",
        "blocks": [
          {
            "type": "para",
            "text": "排程任務可在 Pipeline 內加入「API 連接器」節點，自動呼叫已建好的 DIFY 或 REST API 連接器，把回應丟給下游節點（例如交給「AI 追加」整理、或寫進報告）。適合需要從外部系統（工單、HR、自建服務）定期拉資料的場景。"
          },
          {
            "type": "steps",
            "items": [
              {
                "title": "在 Pipeline 加「API 連接器」節點",
                "desc": "從「+ 新增節點」選單挑「API 連接器」"
              },
              {
                "title": "下拉選連接器",
                "desc": "清單只列出您有權限的連接器（對齊您在對話中能用的範圍）；🤖 為 DIFY、🔌 為 REST API"
              },
              {
                "title": "設定查詢字串（query）",
                "desc": "預設帶上一節點輸出 {{ai_output}}，也可改填固定文字或其他變數（{{date}} / {{node_X_output}}）"
              },
              {
                "title": "填寫固定參數（如有）",
                "desc": "若該連接器定義了需手動提供的參數，會逐欄列出供填寫，可用變數插值"
              }
            ]
          },
          {
            "type": "note",
            "text": "連接器若設定了「必填參數」而排程沒填，該節點會被標為失敗（不會假裝成功往下送錯資料）。建立後請用「立即執行」驗證一次。"
          },
          {
            "type": "tip",
            "text": "只是想把連接器結果注入主 Prompt、不需要多步驟時，直接在 Prompt 用 `{{dify:連接器名稱}}` 語法更簡單，不必建 Pipeline 節點。"
          }
        ]
      },
      {
    ...
    "blocks": [
        ...
        "blocks": [
          {
            ...
            "rows": [
              [
                "規則 (Rule)",
                "主表，定義「監看什麼資料、用什麼條件比較、觸發後要做什麼動作」",
                "alert_rules"
              ],
              [
                "排程 (Schedule)",
                "子表，一條規則可掛多個排程（例如同時設「日 / 週 / 月」三個），各自獨立 cron + lookback",
                "alert_schedules"
              ],
              [
                "歷史 (History)",
                "每次觸發自動記一筆，含當下數值、訊息、發送通道",
                "pm_alert_history"
              ]
            ]
          },
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              {
                "title": "儲存後 alertRuleScheduler 自動接管",
                "desc": "無需重啟服務，下次 fire 時間到了自動評估。"
              }
            ]
          }
        ]
        ...
        "blocks": [
          {
            ...
            "rows": [
              ...
              [
                "間隔",
                "每 N 分鐘（無 cron）",
                "不關心固定時點，週期性檢查（例 ERP 訂單異常每 60 分鐘掃一次）",
                "1 天 / 60 分"
              ]
            ]
          },
      ...
      },
      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "編輯規則 modal 底部有「⏵ 試跑」按鈕，點下去會："
          },
          {
            "type": "list",
            "items": [
          ...
          {
            "type": "tip",
            "text": "改 SQL / 改門檻後務必先試跑一次。觀察結果裡的 current / baseline 數字對不對，再儲存。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "rows": [
              [
                "alert_history",
                "寫一筆到 pm_alert_history（給「歷史」按鈕看，自動加，無法移除）",
                "無"
              ],
              [
                "email",
              ...
              [
                "webex",
                "在 Webex 房間發 Adaptive Card（含 ✓ 已確認按鈕）",
                "room_id"
              ],
              [
                "webhook",
                "POST JSON 到外部 endpoint（可串接 Slack / Teams 等）",
                "url + method + headers"
              ]
            ]
          },
        ...
        "blocks": [
          ...
          },
          {
            ...
            "rows": [
              [
                "基本金屬",
                "[PM] CU/AL/NI/ZN/PB/SN ⊕ 漲幅警示 (>8%)",
                "source LIKE 'Westmetall%'"
              ],
              [
                "貴金屬 PGM",
                "[PM] PT/PD/RH ⊕ 漲幅警示 (>8%)",
        ...
        "blocks": [
          {
            ...
            "rows": [
              [
                "列表「輪詢」欄顯示「未設」紅字",
                "該規則沒掛任何排程（alert_schedules 子表沒記錄）。編輯規則點「+ 日 / + 週 / + 月 / + 間隔」加排程。"
              ],
              [
                "列表「冷卻」欄顯示「1d / 7d / 30d」是什麼",
                "各 schedule 的 cooldown 自動換算單位後的摘要。1d=1440 分、7d=10080 分、30d=43200 分。若所有 schedule cooldown 都一樣就顯示單一值。hover 可看原始分鐘數。"
              ],
              [
                "試跑回「規則已停用」",
                "temp rule is_active=0 是試跑機制本身的設定（避免被 scheduler 撈到），server 端已強制視為 active，若仍看到此訊息請更新 server。"
              ],
              [
                "試跑回「no historical baseline」",
                "SQL 回的資料筆數 < 2，無法算變化率。可能是 metal/entity 沒歷史資料、source filter 太嚴、或 SQL 條件錯。先在 Oracle 直接跑該 SQL 看回幾筆。"
              ],
              [
                "Cron 表達式存不下去",
                "只支援 3 種 pattern（daily/weekly/monthly），用 UI 上「每天/每週/每月」radio 選即可，不需手寫 cron。"
              ],
              [
                "Alert 永遠不觸發",
                "檢查：1) is_active=1  2) schedule.is_active=1  3) next_evaluate_at 已到  4) cooldown 內沒被擋  5) 試跑數字看是否真的過門檻。"
              ],
              [
                "想暫時停用某條規則 / 某個 schedule",
                "規則層級：列表「狀態」欄電源按鈕一鍵切換 is_active。Schedule 層級：編輯規則 → 該排程的「啟用」checkbox 取消勾選。"
              ],
              [
                "Email 沒收到",
                "檢查：1) 收件人在 actions[].to  2) SMTP 設定（Admin → 郵件設定）  3) pm_alert_history 該筆 channels_sent 是否含 \"email\"  4) email server log。"
              ],
              [
                "規則改 cooldown 但似乎沒生效",
                "若該規則有掛排程（schedules 子表非空），rule-level cooldown 會被 **schedule-level cooldown 覆蓋**。要改實際 cooldown 請編輯各 schedule 的 cooldown 欄位，不是 rule-level。"
              ],
              [
                "想批次建多條類似規則",
                "改 server/scripts/seedPmAlertRules.js 在 METALS 陣列加項目，再跑 `node server/scripts/seedPmAlertRules.js`（idempotent，by rule_name 重跑 skip）。"
              ]
            ]
          }
        ]
        ...
        "blocks": [
          {
            ...
            "rows": [
              [
                "Scheduler",
                "server/services/alertRuleScheduler.js（每分鐘 tick，撈 due schedules JOIN rule）"
              ],
              [
                "Cron 算下次 fire",
                "server/services/cronNext.js（純 JS，Asia/Taipei tz-aware）"
              ],
              [
                "規則執行核心",
                "server/services/pipelineAlerter.js（executeAlert，含 4 種 comparison + dispatch）"
              ],
              [
                "REST API",
                "server/routes/alertRules.js（CRUD + /test + /history）"
              ],
              [
                "Admin UI",
                "client/src/components/admin/AlertRulesPanel.tsx"
              ],
              [
                "Seed script",
                "server/scripts/seedPmAlertRules.js（11 metal × 3 schedule）"
              ]
            ]
          },
          {
  ...
  },
  {
    ...
    "blocks": [
      {
        "type": "para",
        "text": "**ERP 工具**是平台包裝好的 Oracle ERP FUNCTION 與 PROCEDURE，透過自然語言就能直接查詢或執行 ERP 資料。管理員在後台註冊後，您可以透過兩種方式使用。"
      },
      {
        "type": "note",
