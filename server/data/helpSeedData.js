        ...
        "blocks": [
          ...
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "在「我的信任裝置」按「綁定當前裝置」進行 Face ID / 指紋註冊時,**Android 手機若出現以下錯誤** 多半是手機本身設定問題,可逐項檢查:"
              },
              {
                "type": "list",
                "items": [
              ...
              {
                "type": "note",
                "text": "**iOS 通常無此問題**(iCloud Keychain 預設啟用)。Android < 13 也用舊 FIDO2 API,不會踩到 Credential Manager 問題。"
              },
              {
                "type": "tip",
                "text": "即使生物辨識綁定失敗,**完全不影響正常登入** — 您仍可走帳密 + Webex/Email 驗證碼,通過後 30 天內同裝置免重認。生物辨識只是 UX 加速,不是必要。"
              }
            ]
          }
        ]
