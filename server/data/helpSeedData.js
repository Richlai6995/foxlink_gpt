    ...
    "blocks": [
        ...
        "items": [
          {
            ...
            "items": [
              ...
              "**主題切換（🎨 調色盤圖示，位於使用者列右側）— 5 種視覺主題任意切換**",
              "使用者資訊、修改密碼、登出圖示"
            ]
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "系統提供 **5 種視覺主題**，可依個人偏好或使用情境（例如白天 / 夜間、長時間閱讀 / 簡報展示）隨時切換。主題設定會同步儲存到您的帳號（伺服器端），**換電腦 / 瀏覽器登入後自動套用**。"
          },
          {
            "type": "steps",
            "items": [
              {
                "title": "點擊左側邊欄底部使用者列的「🎨 調色盤」圖示",
                "desc": "圖示位於使用者頭像旁、修改密碼按鈕（🔑）與登出（🚪）左側"
              },
              {
                "title": "從彈出選單中選擇目標主題",
                "desc": "目前使用中的主題會顯示綠色勾選標記"
              },
              {
                "title": "立即生效，無需重新整理",
                "desc": "整個平台（含 Admin、知識庫、教育訓練等所有頁面）的背景、文字、圖示、卡片、按鈕顏色會瞬間切換"
              }
            ]
          },
          {
          ...
          {
            "type": "tip",
            "text": "**深色（護眼）模式** 特色：側邊欄採暖調深灰與主區做視覺分層，輸入框使用深綠底色（人眼對綠色最不敏感，疲勞度最低），搭配綠色聚焦框，長時間輸入文字最不傷眼。"
          },
          {
            "type": "note",
            "text": "主題設定儲存於個人帳號，不同裝置登入後自動套用。管理員切換模擬其他使用者時，會看到被模擬者的主題。"
          }
        ]
      }
    ]
