    ...
    "blocks": [
        ...
        "blocks": [
          ...
          },
          {
            ...
            "blocks": [
              ...
              {
                "type": "tip",
                "text": "匯出的 HTML 檔案包含所有圖片和音訊（base64 嵌入），無需網路即可完整瀏覽。檔案較大時建議取消勾選「包含音訊」以縮小檔案。"
              }
            ]
          }
        ]
      ...
      },
      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "在「翻譯」分頁可以將課程內容 AI 翻譯為英文和越南文。翻譯範圍包含："
          },
          {
            "type": "list",
            "items": [
              ...
              "章節名稱",
              "投影片文字內容和旁白",
              "Hotspot 區域的導引/提示/探索文字（含獨立語言區域的 label、narration、feedback、測驗提示、探索說明）",
              "題目和選項",
              "翻譯完成後可在語言版底圖管理中為外語版單獨生成語音"
            ]
          }
        ]
      },
