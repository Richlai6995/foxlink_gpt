...
const userSections = [
  ...
  },
  {
    ...
    "blocks": [
      {
        "type": "para",
        "text": "本手冊適用於擁有**上架權限**或**上架及編輯權限**的使用者。您可以建立課程、編輯教材內容、管理題庫和測驗主題、使用 AI 自動生成文字與語音，以及查看學員成績報表。"
      },
      {
        "type": "note",
        "text": "此手冊僅對擁有教育訓練「上架權限」或「上架及編輯權限」的使用者顯示。擁有「上架權限」者可建立與發佈課程；擁有「上架及編輯權限」者額外可編輯其他人的課程內容。"
      },

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "從側邊欄「更多功能」→「教育訓練」進入，點擊頂部的「**課程管理**」tab 即可切換到管理模式，看到您建立的所有課程（含草稿和已封存）。"
          },
          {
            "type": "subsection",
            "title": "建立新課程",
            "blocks": [
              {
                ...
                "items": [
                  ...
                  {
                    "title": "填寫基本資訊",
                    "desc": "課程標題（必填）、描述、分類、及格分數（0–100）"
                  },
                  {
                    "title": "設定封面圖（選配）",
                    "desc": "上傳封面圖片，可用內建裁切工具調整比例"
                  },
                  {
                    "title": "儲存",
                    "desc": "課程建立為「草稿」狀態，尚不會對學員顯示"
                  }
                ]
              },
              {
                "type": "tip",
                "text": "課程有三種狀態：**草稿**（僅開發者可見）→ **已發佈**（學員可見）→ **已封存**（隱藏但資料保留）。可隨時切換。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "在課程卡片選單點擊「複製課程」，系統會完整複製所有章節、投影片、題庫、翻譯內容，建立一個新的草稿課程。適合用於建立相似課程或作為模板。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "可將完整課程（含所有章節、投影片、題目、翻譯、音訊檔案）打包成 ZIP 檔案，用於跨環境遷移或備份。"
              },
              {
                "type": "list",
                "items": [
                  ...
                  "匯入後的課程為草稿狀態，所有圖片和音訊會重新上傳到本地伺服器"
                ]
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "將課程匯出為**單一 .html 檔案**，離線即可在瀏覽器開啟瀏覽，包含完整的互動導覽、語音播放和測驗功能。"
              },
              {
                "type": "subsection",
                "title": "匯出設定",
                "blocks": [
                  {
                    "type": "para",
                    "text": "在課程編輯器 header 點擊「匯出」按鈕，彈出匯出設定面板："
                  },
                  {
                    "type": "table",
                    "headers": ["設定項目", "說明"],
                    "rows": [
                      ["包含語言", "選擇匯出的語言版本（繁中必選，可加英文/越文）"],
                      ["選擇章節", "可勾選只匯出部分章節，或全選匯出完整課程"],
                      ["包含測驗題", "是否包含期末測驗"],
                      ["包含音訊", "嵌入語音導覽（會增加檔案大小）"],
                      ["包含截圖標註", "是否顯示使用者繪製的步驟標註"]
                    ]
                  }
                ]
              },
              {
                ...
                "blocks": [
                  {
                    "type": "para",
                    "text": "匯出的 HTML5 教材支援完整的互動導覽體驗："
                  },
                  {
                    "type": "list",
                    "items": [
                      "**開始導覽**：每個 Hotspot 投影片初始顯示「開始導覽」按鈕，點擊後進入步驟互動模式",
                      "**逐步導引**：一次顯示一個操作步驟，點擊正確區域才進入下一步，右側顯示操作說明和步驟列表",
                      "**錯誤提示**：點錯位置會顯示提示，連續錯 3 次會給出具體提示",
                      "**自動導覽**：點擊「自動播放全部」或「自動導覽」按鈕，自動播放語音並逐步展示所有操作步驟，完成後自動跳到下一頁",
                      "**語音播放**：支援投影片 intro 語音和每個步驟的獨立語音",
                      "**靜音控制**：頂部工具列提供靜音/取消靜音按鈕"
                    ]
                  }
                ]
              },
                ...
                "blocks": [
                  {
                    "type": "list",
                    "items": [
                      "底部導航列：上一頁/下一頁按鈕、進度條、頁碼",
                      "鍵盤快捷鍵：← → 方向鍵或空白鍵翻頁",
                      "多語切換：頂部下拉選單切換語言",
                      "測驗：最後一頁為期末測驗（如有包含），提交後顯示分數和及格/不及格"
                    ]
                  }
                ]
              },
              {
                "type": "tip",
                "text": "匯出的 HTML 檔案包含所有圖片和音訊（base64 嵌入），無需網路即可完整瀏覽。檔案較大時建議取消勾選「包含音訊」以縮小檔案。典型檔案大小約 1–1.2 MB（不含音訊）。"
              }
            ]
          }
        ]
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              {
                "title": "📝 基本資訊",
                "desc": "標題、描述、分類、封面圖、及格分數",
                "color": "blue"
              },
              {
                "title": "📚 章節管理",
                "desc": "新增/刪除/排序章節，管理投影片內容",
                "color": "green"
              },
              {
                "title": "❓ 題庫",
              ...
              {
                "title": "🌐 翻譯",
                "desc": "AI 一鍵翻譯為英文和越南文（含 SSE 即時進度）",
                "color": "cyan"
              },
              {
                "title": "🔗 分享",
                "desc": "設定課程存取權限（使用者/角色/部門/利潤中心/組織）",
                "color": "rose"
              },
              {
                "title": "📊 成績",
          ...
          {
            "type": "note",
            "text": "僅有「使用（view）」權限的使用者，設定、成績、分享三個分頁會被停用，只能預覽投影片內容。"
          }
        ]
      },

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "在章節管理中點擊投影片卡片進入**投影片編輯器**。編輯器為全螢幕覆蓋式，左側為區塊列表，右側為屬性面板。每張投影片由多個「**區塊（Block）**」組合而成，可自由排列。"
          },
          {
            "type": "subsection",
            "title": "投影片模板",
            "blocks": [
              {
                "type": "para",
                "text": "新增投影片時可選擇 **10 種預設模板** 快速建立："
              },
              {
                "type": "table",
                "headers": ["模板名稱", "說明", "適用場景"],
                "rows": [
                  ["標題頁", "置中標題 + 副標題", "課程開頭、章節封面"],
                  ["左圖右文", "左側圖片 + 右側文字", "功能介紹、操作說明"],
                  ["右圖左文", "右側圖片 + 左側文字", "同上，版面變化"],
                  ["步驟教學", "帶編號的操作步驟列表", "SOP 流程、操作指引"],
                  ["全螢幕截圖 + 互動", "Hotspot 互動截圖", "★ 系統操作教學（最常用）"],
                  ["對照比較", "Do/Don't 雙欄 Markdown 表格", "正確vs錯誤操作對照"],
                  ["卡片展示", "2×2 翻轉卡片網格", "術語學習、Q&A 複習"],
                  ["影片頁", "影片播放器 + 說明文字", "操作示範影片"],
                  ["測驗頁", "嵌入式單選題", "隨堂小考"],
                  ["空白畫布", "無預設區塊", "完全自訂版面"]
                ]
              },
              {
                "type": "tip",
                "text": "建議操作型教材以「**全螢幕截圖 + 互動**」模板為主，搭配「步驟教學」和「提示框」補充說明。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                ...
                "blocks": [
                  ...
                  {
                    "type": "tip",
                    "text": "文字區塊的編輯區域為 16 行高的 textarea，可直接輸入 Markdown 語法。學員端會自動渲染為格式化內容。"
                  }
                ]
              },
              {
                ...
                "blocks": [
                  ...
                  },
                  {
                    "type": "list",
                    "items": [
                      "**檔案上傳**：點擊上傳按鈕選擇 PNG/JPG/WebP/GIF",
                      "**剪貼簿貼上**：直接 Ctrl+V 貼上螢幕截圖或複製的圖片",
                      "**URL 輸入**：貼上外部圖片網址"
                    ]
                  },
                  {
                    "type": "para",
                    "text": "可設定 alt text 替代文字。圖片在編輯器中最大顯示高度 384px。"
                  }
                ]
              },
              {
                ...
                "blocks": [
                  {
                    ...
                    "items": [
                      "**上傳影片**：支援 MP4 等常見格式",
                      "**外部 URL**：嵌入 YouTube、Vimeo 或其他影片連結",
                      "編輯器內即時預覽（最大高度 256px）"
                    ]
                  }
                ]
              ...
              },
              {
                ...
                "blocks": [
                  ...
                  },
                  {
                    ...
                    "rows": [
                      ["提示（tip）", "藍色", "操作建議、小技巧"],
                      ["警告（warning）", "橙色", "注意事項、常見錯誤"],
                      ["注意（note）", "紫色", "補充說明、背景知識"],
                      ["重要（important）", "紅色", "必須遵守的規則、安全事項"]
                    ]
                  }
                ]
              },
              {
                "type": "subsection",
                "title": "6. Hotspot 互動截圖區塊",
                "blocks": [
                  {
                    "type": "para",
                    "text": "★ **最核心的互動教材類型**，用於模擬系統操作。詳見下方「Hotspot 互動區域編輯」專節。"
                  }
                ]
              },
              {
                "type": "subsection",
                "title": "7. 拖放區塊（Drag-Drop）",
                "blocks": [
                  {
                    "type": "para",
                    "text": "三種互動拖放模式："
                  },
                  {
                    ...
                    "headers": ["模式", "說明", "範例"],
                    "rows": [
                      ["配對（Matching）", "將左側項目拖到右側對應目標", "術語 ↔ 定義配對"],
                      ["排序（Ordering）", "將項目拖放到正確順序", "操作步驟排序"],
                      ["分類（Categorize）", "將項目拖放到對應分類區", "將功能分類到正確模組"]
                    ]
                  },
                  {
                    "type": "para",
                    "text": "每個模式可設定：可拖動項目文字列表、目標區域、正確/錯誤回饋文字、操作說明。"
                  }
                ]
              },
              {
                "type": "subsection",
                "title": "8. 翻轉卡片區塊（Flip Card）",
                "blocks": [
                  {
                    "type": "list",
                    "items": [
                      "每張卡片有**正面**和**反面**，點擊翻轉",
                      "**排版方式**：網格（Grid）或輪播（Carousel）",
                      "**欄數**：網格模式可設定 1–4 欄",
                      "適合用於術語學習、Q&A 複習、概念記憶"
                    ]
                  }
                ]
              },
              {
                "type": "subsection",
                "title": "9. 情境分支區塊（Branch）",
                "blocks": [
                  {
                    "type": "list",
                    "items": [
                      "設定一個**情境描述**（文字 + 選配圖片）",
                      "新增多個**選項**，每個選項可設定跳轉目標投影片",
                      "標記**最佳選項**（綠色圓圈標示），用於計分",
                      "適合用於決策情境教學，如客訴處理、安全操作判斷"
                    ]
                  }
                ]
              },
              {
                "type": "subsection",
                "title": "10. 即時測驗區塊（Quiz Inline）",
                "blocks": [
                  {
                    "type": "para",
                    "text": "在投影片中嵌入隨堂測驗，支援三種題型："
                  },
                  {
                    "type": "table",
                    "headers": ["題型", "說明", "設定重點"],
                    "rows": [
                      ["單選題", "只有一個正確答案", "點擊綠色勾選標記正確選項"],
                      ["多選題", "可有多個正確答案", "勾選所有正確選項"],
                      ["填空題", "開放式文字作答", "填入正確答案，可用逗號分隔多個可接受答案"]
                    ]
                  },
                  {
                    "type": "para",
                    "text": "每題可設定**分數**和**解析**，學員作答後立即顯示對錯和解析說明。"
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                "type": "list",
                "items": [
                  "**新增區塊**：點擊底部「+ 新增區塊」按鈕，選擇區塊類型",
                  "**排序區塊**：使用上/下箭頭按鈕調整區塊順序",
                  "**刪除區塊**：點擊區塊右上角的刪除按鈕",
                  "**投影片導航**：使用上/下一頁按鈕在同章節的投影片間切換"
                ]
              }
            ]
          }
...

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "每張投影片右側面板提供完整的**語音旁白**功能。語音會在學員瀏覽投影片時自動播放。系統提供**三種方式**建立語音："
          },
          {
            "type": "subsection",
            "title": "方式一：TTS 文字轉語音（AI 生成）",
            "blocks": [
              {
                "type": "steps",
                "items": [
                  {
                    "title": "撰寫旁白文稿",
                    "desc": "在右側「備註 / Notes」文字框中輸入要朗讀的文字"
                  },
                  {
                    "title": "點擊「TTS 生成語音」",
                    "desc": "系統使用 Google Cloud TTS 將文字轉為 MP3 語音檔"
                  },
                  {
                    "title": "播放確認",
                    "desc": "生成後自動出現音訊播放器，可試聽效果"
                  }
                ]
              },
              {
                "type": "para",
                "text": "TTS 語音設定可在「設定」分頁調整："
              },
              {
                "type": "table",
                "headers": ["設定項", "說明", "預設值"],
                "rows": [
                  ["語音名稱", "Google Cloud TTS 語音模型", "cmn-TW-Wavenet-A（女聲）"],
                  ["語速", "朗讀速度（0.5–2.0）", "1.0"],
                  ["音高", "聲調高低（-20–20）", "0"],
                  ["語言", "自動根據投影片語言切換", "zh-TW"]
                ]
              },
              {
                "type": "note",
                "text": "TTS 生成需要旁白文字不為空。如果備註欄位為空，TTS 按鈕會被停用。每次生成會覆蓋上一次的音訊。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                ...
                "items": [
                  {
                    "title": "點擊「錄音」按鈕",
                    "desc": "瀏覽器會請求麥克風權限（首次需同意）"
                  },
                  {
                    "title": "開始說話",
                    "desc": "錄音中按鈕會顯示紅色脈動動畫，表示正在錄製"
                  },
                  {
                    "title": "點擊「停止」",
                    "desc": "錄音結束，WebM 音訊檔自動上傳"
                  }
                ]
              },
              {
                "type": "tip",
                "text": "錄音完成後系統可自動進行語音轉文字（STT），將錄音內容轉錄填入備註欄位。適合不想手打旁白文字的情況。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "直接上傳預先錄製好的音訊檔案（支援 MP3、WebM、WAV 格式）。上傳後同樣可自動觸發語音轉文字。"
              }
            ]
          },
          {
            "type": "subsection",
            "title": "Web Speech 即時語音輸入（STT）",
            "blocks": [
              {
                "type": "para",
                "text": "備註文字框旁邊有一個**麥克風圖示按鈕**，點擊後啟用瀏覽器端的語音辨識（Web Speech API）："
              },
              {
                "type": "list",
                "items": [
                  "**即時辨識**：說話的同時文字即時出現在備註欄位",
                  "**暫時結果**（灰色）和**最終結果**（黑色）分開顯示",
                  "**連續模式**：可持續說話，不會自動中斷",
                  "**免費使用**：不消耗 AI Token，但需要網路連線"
                ]
              },
              {
                "type": "note",
                "text": "Web Speech API 目前僅 Chrome 瀏覽器支援。辨識語言預設為 zh-TW。適合快速輸入短語句；長段落建議改用 Gemini STT（精準度更高）。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "list",
                "items": [
                  "每張投影片只能有**一個語音旁白**，重新生成或上傳會覆蓋舊的",
                  "刪除音訊：點擊播放器旁的刪除按鈕即可移除",
                  "語音會跟隨投影片切換自動播放，學員端可靜音",
                  "翻譯後的投影片需要**另外生成**對應語言的語音（在語言版底圖管理中操作）",
                  "TTS 生成的語音品質較一致，適合正式教材；麥克風錄音更自然，適合有真人講解需求的場景"
                ]
              }
            ]
          }
      ...
      {
        "type": "subsection",
        "title": "Hotspot 互動區域編輯（詳細說明）",
        "blocks": [
          {
            "type": "para",
            "text": "Hotspot 是**最核心的互動教材類型**，用於模擬系統操作。學員必須點擊正確的 UI 元素才能完成操作步驟。"
          },
          {
            "type": "subsection",
            "title": "編輯流程",
            "blocks": [
              {
                ...
                "items": [
                  {
                    "title": "上傳系統截圖",
                    "desc": "上傳目標系統的畫面截圖，或使用 AI 錄製功能自動截圖"
                  },
                  {
                    "title": "繪製互動區域",
                    "desc": "在截圖上拖拉滑鼠繪製矩形區域，框選要互動的 UI 元素（如按鈕、輸入框）"
                  },
                  {
                    "title": "設定區域屬性",
                    "desc": "設定標籤名稱、是否為正確區域、回饋文字、最大嘗試次數"
                  },
                  {
                    "title": "設定三種導覽文字與語音",
                    "desc": "學習導引、測驗提示、探索說明各自的文字和語音"
                  },
                  {
                    "title": "AI 生成全套腳本（選配）",
                    "desc": "點擊「AI 生成全套導覽腳本 + 語音」自動填寫所有文字並生成語音"
                  }
                ]
              }
            ]
          ...
          {
            "type": "subsection",
            "title": "互動區域（Region）屬性",
            "blocks": [
              {
                "type": "table",
                "headers": ["屬性", "說明", "預設"],
                "rows": [
                  ["標籤（Label）", "區域名稱，如「確定按鈕」「帳號輸入框」", "—"],
                  ["類型", "button / input / link / select / checkbox / tab / menu / icon", "button"],
                  ["正確區域", "標記為操作步驟中需要點擊的目標", "false"],
                  ["最大嘗試次數", "學員在測驗模式中最多可嘗試幾次（1–10）", "3"],
                  ["幾次後顯示提示", "錯誤幾次後顯示測驗提示", "3"],
                  ["回饋文字", "點擊此區域時顯示的文字（正確/錯誤均可設）", "—"]
                ]
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "每個**正確區域**可設定三種語音，對應學員不同的學習模式："
              },
              {
                "type": "table",
                "headers": ["模式", "圖示", "用途", "範例"],
                "rows": [
                  ["學習導引", "📖", "學習模式下自動播放，詳細講解操作方法", "「請點擊右上角的『新增』按鈕來建立一筆新的工單」"],
                  ["測驗提示", "📝", "測驗模式下錯誤多次後給予提示", "「提示：新增按鈕通常在頁面右上方」"],
                  ["探索說明", "🔍", "探索模式下點擊時簡短說明", "「新增按鈕 — 點擊後進入新建工單頁面」"]
                ]
              },
              {
                "type": "para",
                "text": "每種模式都有獨立的**文字欄位**和**語音按鈕**（TTS / 錄音 / 上傳三選一）。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "點擊「**AI 自動辨識互動區域**」按鈕，系統使用 Gemini Vision 分析截圖："
              },
              {
                "type": "list",
                "items": [
                  "自動偵測截圖中所有可互動的 UI 元素（按鈕、輸入框、連結、下拉選單、核取方塊等）",
                  "為每個元素生成矩形區域，標記座標（百分比格式，確保不同螢幕大小一致）",
                  "自動辨識元素類型（button / input / link / select 等）和標籤文字",
                  "標記主要操作元素（is_primary = true）",
                  "自動偵測敏感資訊區域（如個資、密碼），建議加上馬賽克"
                ]
              },
              {
                "type": "note",
                "text": "AI 辨識的結果為建議性質，請務必人工確認區域位置和正確性。AI 可能遺漏小型 icon 按鈕或辨識錯誤。辨識完成後可手動微調區域位置和大小。"
              }
            ]
          },
          {
            "type": "subsection",
            "title": "AI 生成全套導覽腳本 + 語音",
            "blocks": [
              {
                "type": "para",
                "text": "點擊「**AI 生成全套導覽腳本 + 語音**」按鈕，AI 會一次完成以下工作："
              },
              {
                "type": "steps",
                "items": [
                  {
                    "title": "分析截圖 + 所有正確區域",
                    "desc": "AI 綜合理解頁面功能和每個區域的用途"
                  },
                  {
                    "title": "自動撰寫三種導覽文字",
                    "desc": "為每個正確區域生成：學習導引、測驗提示、探索說明"
                  },
                  {
                    "title": "自動生成 TTS 語音",
                    "desc": "將所有文字轉為語音（使用設定頁面中指定的 TTS 語音）"
                  }
                ]
              },
              {
                "type": "tip",
                "text": "此功能可大幅加速教材製作。一個有 5 個互動區域的投影片，手動編寫需要填寫 15 個文字欄位 + 15 個語音，AI 可在 10–20 秒內全部完成。"
              },
              {
                "type": "note",
                "text": "AI 生成的文字風格為親切、口語化的操作指引。生成後建議快速瀏覽確認內容是否正確，尤其是專有名詞和操作邏輯。如需調整，可直接編輯文字後重新生成該區域的 TTS 語音。"
              }
            ]
          },
          {
            "type": "subsection",
            "title": "標註系統（Annotation）",
            "blocks": [
              {
                "type": "para",
                "text": "截圖上可疊加**視覺標註**，幫助學員快速識別操作位置。標註工具列提供："
              },
              {
                "type": "table",
                "headers": ["工具", "快捷鍵", "說明"],
                "rows": [
                  ...
                  ["文字標籤", "5", "添加自由文字說明"],
                  ["顏色選擇", "—", "紅/藍/綠/黃/白 五色可選"],
                  ["撤銷/重做", "Ctrl+Z / Ctrl+Y", "復原或重做操作"]
                ]
              },
              {
                "type": "para",
                "text": "標註會顯示在截圖上方，可拖曳移動位置。AI 分析截圖時會**優先識別有標註的位置**，以使用者標記的步驟順序為準。"
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "如果不同語言的系統介面截圖不同（如按鈕文字不同），可在 Hotspot 編輯器中打開「**多語底圖管理**」面板："
              },
              {
                "type": "list",
                "items": [
                  "為英文（en）和越南文（vi）各上傳不同的截圖底圖",
                  "每個語言的互動區域可選擇**繼承主語言**或**獨立設定**",
                  "獨立設定時可調整區域的位置、大小，以及對應語言的所有文字和語音",
                  "翻譯功能會自動翻譯各語言 region 的 label、narration、feedback 等文字",
                  "翻譯完成後可為外語版單獨生成 TTS 語音"
                ]
              },
              {
                "type": "note",
                "text": "若系統介面只有語言文字不同、版面配置相同，可只上傳不同語言的截圖，互動區域位置繼承主語言即可，不需獨立調整。"
              }
            ]
          }
        ]
      ...
      {
        "type": "subsection",
        "title": "AI 錄製功能（Chrome Extension）",
        "blocks": [
          {
            "type": "para",
            "text": "使用 Chrome 擴充功能在目標系統上錄製操作步驟，自動截圖並 AI 生成互動教材。這是建立操作型教材**最快速**的方式。"
          },
          {
            "type": "subsection",
            "title": "安裝與設定",
                ...
                "items": [
                  {
                    ...
                    "desc": "開啟 chrome://extensions → 開啟「開發者模式」→ 載入解壓縮的 chrome-extension 資料夾"
                  },
                  {
                    "title": "登入",
                    "desc": "Extension Popup 中輸入 Server URL（如 http://10.8.93.11:3007）和您的帳號密碼"
                  },
                  {
                    "title": "取得 Session ID",
                    "desc": "在課程編輯器的「章節管理」分頁，點擊「AI 錄製」按鈕，系統會產生一組 Session ID"
                  },
                  {
                    "title": "Extension 貼上 Session ID",
                    "desc": "在 Extension Popup 中貼上 Session ID，點擊「開始錄製」"
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                "type": "list",
                "items": [
                  "切換到目標系統的瀏覽器分頁，正常操作系統",
                  "每次 UI 互動（點擊按鈕、輸入文字、切換頁面）Extension 會**自動截圖**",
                  "截圖會即時上傳到 Server，在課程編輯器的錄製面板中可看到縮圖",
                  "支援**手動截圖**模式（適合需要精確控制截圖時機的場景）",
                  "錄製中可在截圖上**即時標註**（步驟編號、圓圈、箭頭、文字等）",
                  "可隨時暫停/繼續錄製"
                ]
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "錄製完成後，在課程編輯器的錄製面板中可以："
              },
              {
                "type": "list",
                "items": [
                  "**預覽所有截圖**：以縮圖網格顯示所有錄製步驟",
                  "**重新排序**：拖放調整步驟順序",
                  "**刪除步驟**：移除不需要的截圖",
                  "**標記語言**：為每個截圖標記是 zh-TW / en / vi 哪個語言版本",
                  "**標記關鍵步驟**：勾選重要步驟，AI 生成時會優先處理",
                  "**手動補充**：可用 Ctrl+V 貼上或上傳額外截圖",
                  "**儲存草稿**：儲存目前的錄製進度，關閉後再開啟可繼續",
                  "**AI 分析單一步驟**：點擊步驟旁的「分析此步驟」按鈕，AI 辨識該截圖的互動區域"
                ]
              }
            ]
          },
            ...
            "blocks": [
              ...
              },
              {
                ...
                "items": [
                  {
                    "title": "批次 AI 分析",
                    "desc": "對所有截圖進行 Gemini Vision 分析，偵測互動區域"
                  },
                  {
                    "title": "建立投影片",
                    "desc": "每個截圖建立一張 Hotspot 投影片，自動帶入互動區域"
                  },
                  {
                    "title": "保留標註",
                    "desc": "使用者在錄製時畫的標註會保留在投影片中"
                  },
                  {
                    "title": "多語言底圖",
                    "desc": "若同一步驟有多語言截圖，自動建立語言版底圖對應（image_overrides）"
                  },
                  {
                    "title": "生成文字和語音",
                    "desc": "AI 為每個區域生成操作說明文字和 TTS 語音"
                  }
                ]
              },
              {
                "type": "tip",
                "text": "錄製 + AI 生成的教材建議**逐一檢查**每張投影片：確認互動區域位置正確、文字描述準確、步驟順序合理。AI 辨識的精準度約 80–90%，需要人工微調。"
              }
            ]
          }
        ]
...

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "除了 Chrome Extension 錄製，也可以直接批次上傳截圖檔案快速建立教材："
          },
          {
            "type": "steps",
            "items": [
              {
                "title": "拖放或選取多個 PNG/JPG 檔案",
                "desc": "支援一次上傳多張截圖"
              },
              {
                "title": "開啟「AI 自動辨識」開關（選配）",
                "desc": "開啟後每張截圖會自動使用 Gemini Vision 偵測互動區域"
              },
              {
                "title": "開始上傳",
                "desc": "系統平行處理所有截圖，顯示逐一進度（pending → uploading → analyzing → done）"
              }
            ]
          },
          {
            "type": "para",
            "text": "上傳完成後，每張截圖自動建立一張投影片。若 AI 偵測到互動區域，會建立 Hotspot 投影片；否則建立一般圖片投影片。"
          }
        ]
      },

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "教材開發中所有 AI 功能的完整列表與使用建議："
          },
          {
            "type": "table",
            "headers": ["AI 功能", "觸發方式", "使用的 AI 模型", "耗時"],
            "rows": [
              ["截圖互動區域辨識", "Hotspot 編輯器「AI 自動辨識」按鈕", "Gemini Flash（Vision）", "3–8 秒/張"],
              ["導覽腳本 + 語音生成", "Hotspot 編輯器「AI 生成全套腳本」按鈕", "Gemini Flash + Google TTS", "10–20 秒"],
              ["TTS 文字轉語音", "語音面板「TTS 生成語音」按鈕", "Google Cloud TTS", "2–5 秒"],
              ["語音轉文字（Gemini STT）", "錄音上傳後自動觸發", "Gemini Flash", "3–8 秒"],
              ["語音轉文字（Web Speech）", "備註欄位麥克風按鈕", "瀏覽器內建（免費）", "即時"],
              ["AI 翻譯", "翻譯分頁「翻譯」按鈕", "Gemini Flash", "依內容量"],
              ["AI 題庫生成", "題庫分頁「AI 生成題目」按鈕", "Gemini Pro", "10–30 秒"],
              ["批次截圖分析", "批次匯入 + AI 開關", "Gemini Flash（Vision）", "3–8 秒/張"],
              ["錄製步驟分析", "錄製面板「分析此步驟」或「生成投影片」", "Gemini Flash（Vision）", "3–8 秒/張"]
            ]
          },
          {
            "type": "subsection",
            ...
            "blocks": [
              {
                "type": "list",
                "items": [
                  "**Token 消耗**：所有 AI 功能（TTS 除外）都會消耗 Gemini API Token。大量使用前請確認 Token 額度充足",
                  "**截圖品質**：AI 辨識精準度高度依賴截圖品質。建議使用 100% 縮放的清晰截圖，避免模糊或局部截圖",
                  "**敏感資訊**：AI 會自動偵測截圖中的個資（姓名、身份證號、手機號碼等），但**不保證 100% 偵測率**。上傳截圖前請自行確認是否需要遮蔽敏感資訊",
                  "**專有名詞**：AI 生成的文字可能不準確翻譯或解釋公司內部專有名詞。生成後請務必檢查",
                  "**重複生成**：重新執行 AI 生成會**覆蓋**之前的結果（文字和語音），請確認後再執行",
                  "**併發限制**：同時大量觸發 AI 分析（如批次匯入 20+ 張截圖）可能導致部分請求超時。建議分批處理",
                  "**TTS 語音風格**：TTS 生成的語音是機器合成聲音，對於需要情感表達的場景（如安全警示），建議改用麥克風真人錄音"
                ]
              }
            ]
          }
...

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "在「題庫」分頁可管理課程的期末測驗題目。支援以下題型："
          },
          {
            "type": "table",
            "headers": ["題型", "說明", "計分方式"],
            "rows": [
              ["單選題", "只有一個正確答案", "全對得分，其餘 0 分"],
              ["多選題", "可有多個正確答案", "部分給分（可設定錯選扣分比例）"],
              ["填空題", "開放式文字作答", "精確比對或 AI 語意判斷"],
              ["配對題", "左右項目配對", "全對或部分給分"],
              ["排序題", "將項目排列成正確順序", "全對或部分給分"]
            ]
          },
          {
            "type": "subsection",
            ...
            "blocks": [
              {
                "type": "para",
                "text": "點擊「**AI 生成題目**」按鈕，系統會根據課程內容自動產生測驗題目。可設定："
              },
              {
                "type": "list",
                "items": [
                  ...
                  "**題型選擇**：指定生成哪些題型",
                  "**難度等級**：簡單 / 中等 / 困難",
                  "**AI 模型**：Flash（快速）或 Pro（精準）",
                  "AI 會自動產生題目、選項、正確答案和解析",
                  "生成後可逐題編輯調整"
                ]
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "填空題支援**精確比對**和 **AI 語意判斷**兩種評分方式。AI 判斷模式下，即使學員的答案用詞不同但意思相近，仍可獲得分數。"
              },
              {
                "type": "note",
                "text": "AI 語意判斷會消耗 Token，且判斷結果可能有誤差。建議重要考核仍以精確比對為主，或由管理員人工複審 AI 判分結果。"
              }
            ]
          }
        ]
...

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "在「測驗主題」分頁可建立不同的測驗組合。一個課程可以有多個測驗主題，適合不同階段或不同學員群組使用。"
          },
          {
            "type": "table",
            "headers": ["設定項", "說明"],
            "rows": [
              ["主題標題", "如「基礎操作」「進階功能」「全系統考核」"],
              ["包含章節", "勾選要納入此測驗的章節"],
              ["滿分", "此測驗的總分（預設 100）"],
              ["及格分數", "及格門檻分數"],
              ["時間限制", "作答時間限制（分鐘），0 表示不限時"],
              ["超時處理", "時間到自動結算，或僅提醒可繼續作答"],
              ["配分方式", "平均分配 或 自訂每題分數權重"]
            ]
          },
          {
            "type": "para",
            "text": "學員在課程詳情頁可看到所有測驗主題，選擇後開始測驗。每個測驗主題的成績獨立計算。"
          }
        ]
      },

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "在「翻譯」分頁可以將課程內容 AI 翻譯為**英文（en）**和**越南文（vi）**。翻譯使用 SSE 串流，即時顯示翻譯進度。"
          },
          {
            "type": "subsection",
            "title": "翻譯範圍",
            "blocks": [
              {
                ...
                "items": [
                  "課程標題和描述",
                  "所有章節名稱",
                  "投影片的所有文字內容（包含 content_json 中的文字欄位，結構和類型欄位不翻譯）",
                  "投影片備註 / 旁白文字",
                  "Hotspot 區域的所有文字：label、narration（學習導引）、feedback（回饋）、test_hint（測驗提示）、explore_desc（探索說明）",
                  "獨立語言區域（language-specific regions）的所有文字",
                  "題庫的題目文字、選項、解析",
                  "可選擇翻譯**全部章節**或只翻譯**特定章節**"
                ]
              }
            ]
          },
            ...
            "blocks": [
              {
                ...
                "items": [
                  ...
                  {
                    "title": "點擊「翻譯」",
                    "desc": "系統開始批次翻譯，進度條顯示目前/總數"
                  },
                  {
                    "title": "確認翻譯狀態",
                    "desc": "翻譯完成的項目會標記為 ✅，可點擊查看翻譯內容"
                  }
                ]
              }
            ]
          },
          {
            ...
            "blocks": [
              {
                "type": "para",
                "text": "翻譯只處理**文字內容**，不會自動生成外語版語音。完成翻譯後，需在以下位置為外語版生成語音："
              },
              {
                "type": "list",
                "items": [
                  "**投影片旁白**：切換到對應語言的投影片，在語音面板重新生成 TTS",
                  "**Hotspot 區域語音**：在「多語底圖管理」面板中，切換到對應語言，為每個區域生成 TTS",
                  "也可使用「AI 生成全套腳本 + 語音」按鈕一次生成該語言的所有區域語音"
                ]
              }
            ]
          },
          {
            "type": "note",
            "text": "翻譯結果儲存在獨立的翻譯表中（不覆蓋原始中文內容）。系統會標記翻譯為「自動翻譯」，管理員可在翻譯面板中手動修正。重新翻譯會覆蓋之前的翻譯結果。"
          }
        ]
      },

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "在「分享」分頁可設定哪些人可以存取此課程，支援**多維度**分享："
          },
          {
            "type": "table",
            "headers": ["分享維度", "說明"],
          ...
          {
            "type": "para",
            "text": "每個分享對象可設定兩種權限：**使用（view）**（僅學習和測驗）或 **開發（develop）**（可編輯課程內容）。"
          },
          {
            "type": "para",
            "text": "也可將課程設為「**公開**」，所有登入使用者都能看到並學習。"
          }
        ]
      },

      {
        ...
        "blocks": [
          ...
          {
            "type": "para",
            "text": "已發佈的課程可隨時「**取消發佈**」回到草稿狀態（學員將無法看到），或「**封存**」移除但保留資料。"
          }
        ]
      },
        ...
        "blocks": [
          ...
          },
          {
            ...
            "rows": [
              ...
              ["投影片統計", "每張互動投影片的操作次數、平均分數、平均錯誤次數、耗時分析"],
              ["使用者明細", "每位學員的測驗紀錄、分數、嘗試次數，可展開查看 per-slide 逐頁明細"]
            ]
          },
          {
            "type": "tip",
            "text": "投影片統計可幫助識別教材中的**難點**：如果某張投影片的平均錯誤次數特別高，可能需要改善該步驟的操作說明或增加提示。"
          }
        ]
      },

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "在管理員後台「教育訓練報表」中，提供兩個報表 tab："
          },
          {
            "type": "subsection",
            "title": "章節完成率",
...

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "在「課程管理」頁面的「**訓練專案**」tab 可建立大規模課程指派。訓練專案將多個課程打包，指派給特定人員群組。"
          },
          {
            "type": "subsection",
            "title": "建立訓練專案",
            "blocks": [
              {
                ...
                "headers": ["設定項", "說明"],
                "rows": [
                  ["專案名稱", "如「2026 Q2 新進人員訓練」"],
                  ["目的說明", "專案目標描述"],
                  ["開始/結束日期", "專案有效期間"],
                  ["及格分數", "專案整體及格門檻（預設 60）"],
                  ["章節鎖定", "是否要求依序完成章節（不可跳章節）"],
                  ["週期性", "可設定為每年/半年/每季/自訂重複"]
                ]
              }
            ]
          },
            ...
            "blocks": [
              {
                ...
                "items": [
                  "在專案中新增課程，可指定只包含部分章節",
                  "可為每個課程覆蓋測驗設定（獨立配分、時間限制）",
                  "指派人員支援多維度：使用者、角色、部門、利潤中心、組織段、組織群組",
                  "啟動專案後，系統自動展開指派到每位個人學員",
                  "支援豁免管理：可標記特定學員免訓（附豁免原因）"
                ]
              }
            ]
          },
          ...
          {
            "type": "tip",
            "text": "週期性專案在每個週期開始時會自動重新指派。可設定重置模式：**完全重來**（重新學習和測驗）或**僅重考**（只需重新通過測驗）。"
          }
        ]
      },

      {
        ...
        "blocks": [
          {
            "type": "para",
            "text": "課程編輯器的「設定」分頁提供以下設定："
          },
          {
            "type": "table",
            "headers": ["設定區域", "項目", "說明"],
            "rows": [
              ["測驗配分", "總分", "整份測驗的滿分（預設 100）"],
              ["測驗配分", "及格分數", "及格門檻"],
              ["測驗配分", "時間限制", "作答時間限制（分鐘）"],
              ["測驗配分", "配分方式", "平均分配 / 自訂每題權重"],
              ["TTS 語音", "語音名稱", "Google Cloud TTS 語音模型選擇"],
              ["TTS 語音", "語速", "朗讀速度 0.5–2.0"],
              ["TTS 語音", "音高", "聲調高低 -20–20"],
              ["AI 模型", "分析模型", "用於截圖辨識和腳本生成的 Gemini 模型"],
              ["AI 模型", "翻譯模型", "用於課程翻譯的 Gemini 模型"]
            ]
          }
        ]
      },
        ...
        "blocks": [
          {
            "type": "list",
            "items": [
              "**截圖品質**：使用 100% 瀏覽器縮放，擷取完整頁面，避免部分截圖或模糊圖片",
              "**步驟拆分**：每張投影片只教一個操作步驟，避免一頁塞太多互動區域",
              "**善用 AI 生成**：先讓 AI 生成初稿，再人工微調文字和區域位置，效率最高",
              "**先做中文版**：完成中文版所有內容後再翻譯，避免反覆修改導致翻譯過期",
              "**語音搭配**：操作教學建議搭配 TTS 語音，讓學員「聽」操作指引的同時動手操作",
              "**測試學習流程**：發佈前在課程編輯器中點擊「預覽」，以學員視角完整跑一遍學習和測驗流程",
              "**標註提示**：在截圖上加步驟編號標註，幫助學員快速定位操作位置",
              "**敏感資訊**：截圖中如有個資、密碼等敏感資訊，使用標註工具的馬賽克功能遮蔽"
            ]
          }
        ]
      }
        ...
        "blocks": [
          {
            ...
            "rows": [
              ...
              [
                "我的工單別人看得到嗎？",
                "一般使用者只能看到自己的工單，管理員可以看到所有工單。"
              ],
              [
                "AI 分析會用到我的個人資料嗎？",
                "不會。AI 搜尋歷史工單時採用脫敏機制，不會顯示其他人的個人資訊。"
              ],
              [
                "工單附件有大小限制嗎？",
                "單檔 50MB，不允許上傳影片檔案。"
