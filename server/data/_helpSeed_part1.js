...

  {
    ...
    blocks: [
      ...
      },
      {
        ...
        blocks: [
          { type: 'para', text: '若您**從公司外網**(出差、家用、行動網路)連線 Cortex,系統會在帳密驗證通過後,**多走一道 Webex DM 驗證碼確認**。內網(辦公室 / 廠區)使用者完全無感,流程跟過去一致。' },
          {
            type: 'steps',
            items: [
              { title: '輸入帳號密碼後,系統判斷您不在內網範圍' },
              { title: 'Webex Bot 自動私訊您一個 6 位數驗證碼', desc: '5 分鐘內有效;同時告訴您「來源 IP」讓您確認是不是自己操作' },
          ...
          { type: 'note', text: '**沒收到驗證碼怎麼辦?** 1) 確認 Webex App 開著且通知開啟 2) 檢查跟 Cortex Bot 的 1:1 對話 3) 若一直收不到,登入畫面會顯示「事件代碼」,把它告訴系統管理員可協助查詢' },
