...
const bookLastModified = '2026-04-28';
...
const briefingLastModified = '2026-04-28';
        ...
        blocks: [
          {
            ...
            cols: 2,
            items: [
              { emoji: '🏷️', title: '1. 報價 banner(置頂常駐)', desc: '依「我的偏好」顯示關注金屬,**捲動仍可見**;[展開全部] 看 11 金屬完整清單;**今日不齊時自動橘色警示列出缺哪些金屬**' },
              { emoji: '⭐', title: '2. 今日 AI 綜述', desc: '從每日金屬日報排程撈,前 250 字摘要 + [看完整日報] 展開全文 + 👍 thumbs feedback;**fallback 文字會動態顯示實際排程時間**' },
              { emoji: '📊', title: '3. 排程資料健康度面板(2026-04-28 加)', desc: '一頁看完 6 個 [PM] 排程任務跑況;預設摺疊,有 alert 才展開;讓使用者一眼看出哪個排程沒生資料' },
              { emoji: '📑', title: '4. 5 個 Tab(內容區)', desc: '[新聞列表(預設)] [歷史價格] [週報] [月報] [Prompt 審核] — Prompt 審核從原獨立頁整合進來,sidebar 不再多入口' },
              { emoji: '⚙️', title: '5. Top bar 操作', desc: '右上有 [⚙ 我的偏好] 設關注金屬 / 是否預設只看 24h、[⬇ 匯出 CSV] 下載 30 天價格' },
            ]
          },
        ]
      },
        ...
        blocks: [
          {
            ...
            blocks: [
              ...
              },
              {
                type: 'list',
                items: [
                  '**第一列(最顯眼)**:📅 日期 · 來源(可點開原文,顯眼藍底) · 情緒色標 · 金屬 tag — 採購最關心「這篇是誰寫的、什麼時候、什麼金屬」',
                  '第二列:標題(粗體,點開原文)',
                  '第三列:中文摘要(80-150 字)',
                  '第四列:👍/👎 thumbs feedback',
                  '左側釘選按鈕保持(收藏)',
              ...
              {
                type: 'note',
                text: '原版日期擠在卡片右上小字,使用者抱怨找不到 / 不顯眼。改完後日期 + 來源連結搬到左上,跟標題分離。'
              },
              {
                type: 'table',
                headers: ['篩選器', '說明'],
        ...
        blocks: [
          {
            ...
            headers: ['屬性', '值'],
            rows: [
              ['排程',     '每日 09:00 + 14:30(multi_time)'],
              ['模型',     'Flash(快、便宜)'],
              ['做什麼',   '抓 4 個一般市場新聞源 + 3 個 PGM 機構評論源,LLM 摘要 + 情緒分析'],
              ['寫入',     'pm_news 表(upsert by url_hash;重複 URL 改 update 而非 silent skip)+ PM-新聞庫'],
              ['下游',     '日報 / Workflow news_agent 都會 RAG 查詢這個 KB'],
            ]
          },
          {
            type: 'subsection',
            title: '資料源(2026-04-28 更新採購需求)',
            blocks: [
              {
                type: 'table',
                headers: ['類型', '來源', '備註'],
                rows: [
                  ['一般新聞 1', 'Mining.com /feed/ RSS', '36+ items 含完整內文,**主源**'],
                  ['一般新聞 2', 'MoneyDJ 商品原物料', '中文台灣財經角度'],
                  ['一般新聞 3', 'SMM 上海有色網', '中文中國市場視角'],
                  ['一般新聞 4', '日經中文 大宗商品', '政經視角'],
                  ['PGM 評論 1', 'WPIC(platinuminvestment.com)', '機構級鉑金供需報告'],
                  ['PGM 評論 2', 'matthey expert-insights', 'Johnson Matthey PGM 專家文章'],
                  ['PGM 評論 3', 'matthey PGM markets', 'PGM 市場頁'],
                ]
              },
              {
                type: 'note',
                text: '**KITCO Latest Metals News + MarketWatch 已驗證無法爬**(KITCO 列表頁 JS-rendered 沒 RSS,MarketWatch 對非登入回 401)。Mining.com RSS 涵蓋同類新聞作 KITCO 替代。'
              },
            ]
          },
        ]
        ...
        blocks: [
          {
            ...
            rows: [
              ...
              ['模型',     '**Pro**(深度收集,需綜合判斷)'],
              ['做什麼',   '抓 11 金屬當日報價(Au/Ag/Pt/Pd/Rh + Cu/Al/Ni/Sn/Zn/Pb)+ 全網新聞 + PGM 機構評論'],
              ['寫入',     'pm_news + **pm_price_history(11 筆 prices upsert by metal_code+as_of_date)** + PM-原始資料庫'],
              ['下游',     '所有戰情 Design 的價格類圖表都讀 pm_price_history;歷史價格 tab 也是'],
            ]
          },
          {
            type: 'subsection',
