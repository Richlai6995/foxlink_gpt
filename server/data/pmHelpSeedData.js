...
const bookLastModified = '2026-04-27';
...
const sections = [
  ...
  // ── 1.5. 採購每日工作中心(Phase 5 後新增的主頁)──────────────────────────
  {
    ...
    last_modified: '2026-04-27',  // bump:5 tab、歷史價格 chart 細節、CSV 詳細匯出、報價 banner 修
        ...
        blocks: [
          {
            ...
            items: [
              ...
              { emoji: '📑', title: '3. 5 個 Tab(內容區)', desc: '[新聞列表(預設)] [歷史價格] [週報] [月報] [Prompt 審核] — Prompt 審核從原獨立頁整合進來,sidebar 不再多入口' },
        ...
        blocks: [
          ...
          },
          {
            ...
            blocks: [
              {
                type: 'para',
                text: '採購每天最常看的 tab — **金屬價格 line chart + 完整資料表**,還能疊「AI 預測線」「實際採購點」做擇時分析。'
              },
              {
                type: 'subsection',
                title: '篩選器 + 圖表',
