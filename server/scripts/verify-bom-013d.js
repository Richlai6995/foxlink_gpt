...
(async () => {
  ...
  // ── BOM superset 46 表總結 ──
  console.log('\n=== BOM superset 全 46 表總結(013a–d)===');
  const ALL = [
    'BOM_FACTORY','BOM_PROCESS_CATALOG','BOM_CS_COMPONENT','BOM_EQUIP_CATEGORY_CATALOG','BOM_FACTORY_BASELINE',
    'BOM_FACTORY_IDL_ROLE','BOM_FACTORY_IDL_LINEDEP_WAGE','BOM_FACTORY_DEP_YEARS','BOM_FACTORY_EQUIP_CATEGORY_PRICE',
    ...
    'BOM_CS_CASE_FACTORY','BOM_CS_CASE_PROCESS','BOM_CS_CASE_IDL_ALLOC','BOM_CS_CASE_EQUIP_CATEGORY','BOM_CS_CASE_CONSUMABLE',
